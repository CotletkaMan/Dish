 ...
 */
public class SecondDishesPresenterImpl extends DishesPresenterImpl {
    private RemoteAccess remoteAccess;


    public SecondDishesPresenterImpl(Place place , ClientFactory factory){
        super(place , factory , "Second");
        remoteAccess = factory.getRemoteAccess();
    }

    protected void getDishes(){
        remoteAccess.getType("SECOND", new MethodCallback<List<ShortDish>>() {
            @Override
