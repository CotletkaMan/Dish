 ...
 */
public class SecondButtonViewImpl extends Composite implements ButtonView {
    interface ExamplePanelUiBinder extends UiBinder<Widget, SecondButtonViewImpl> {}
